...
def handle_setup(manifest: REManifest, args: dict):
    ...
    git_user = prompt_for_input("GitHub User: ", "str", default="")
    ...
    # Requirements
    try:
        plog(f"Installing {manifest.rem}/requirements.txt ... ", 1, args)
        exec_this(f"pip3 install -r {manifest.rem}/requirements.txt")
